...
!!! note
   ...
   ![MyAccessID login](../assets/Linked_accounts_myaccessid_login_without_eduid_option_visible.png)
   ![MyAccessID login](../assets/Linked_accounts_myaccessid_login_with_eduid_option_visible.png)
